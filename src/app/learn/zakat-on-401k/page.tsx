      ...
      <article className="min-h-screen bg-white px-6 py-16 dark:bg-gray-800">
        <div className="mx-auto max-w-3xl">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed dark:text-gray-300">Take your current 401(k) balance. Subtract estimated federal tax (~22%), state tax (~5%), and early withdrawal penalty (~10%). The result is your accessible value. Multiply by 2.5% for your zakat.</p>
          </section>
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-3 dark:text-gray-100">Example Calculation</h2>
            <p className="text-gray-700 leading-relaxed dark:text-gray-300">401(k) balance: $100,000. Estimated taxes + penalty: ~$37,000. Accessible value: $63,000. If your total wealth exceeds nisab: Zakat = $63,000 x 2.5% = $1,575.</p>
          </section>
          ...
          <section className="mb-8">
            ...
            <div className="space-y-4">
              <details className="border rounded-lg">
                <summary className="p-4 cursor-pointer font-semibold text-gray-900 hover:text-green-700 dark:text-gray-100">Do I pay zakat on my employer match?</summary>
                <div className="px-4 pb-4 text-gray-700 dark:text-gray-300">Most scholars say yes — the employer match is wealth you own even if you did not contribute it directly.</div>
              </details>
              <details className="border rounded-lg">
                <summary className="p-4 cursor-pointer font-semibold text-gray-900 hover:text-green-700 dark:text-gray-100">What about Roth IRA?</summary>
                <div className="px-4 pb-4 text-gray-700 dark:text-gray-300">Roth IRAs are funded with after-tax money. You can withdraw contributions (not earnings) penalty-free. Scholars generally treat the contribution portion as fully zakatable.</div>
              </details>
            </div>
          </section>
