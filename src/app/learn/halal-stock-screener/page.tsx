...
export const metadata: Metadata = {
  title: 'Free Halal Stock Screener — Screen 30,000+ Stocks | Barakah',
  description: 'Screen stocks against AAOIFI Standard 21 compliance criteria. Check any stock for halal/haram status with sector and financial ratio analysis.',
      ...
      <article className="min-h-screen bg-white px-6 py-16">
        <div className="mx-auto max-w-3xl">
          <nav className="mb-6 text-sm">
            ...
            <span className="mx-2 text-gray-400">/</span>
            <span className="text-gray-600">Free Halal Stock Screener</span>
          </nav>
          <h1 className="text-4xl font-bold text-gray-900 mb-6">Free Halal Stock Screener</h1>
          <p className="text-lg text-gray-700 leading-relaxed mb-8">Screen stocks against AAOIFI Standard 21 compliance criteria. Check any stock for halal/haram status with sector and financial ratio analysis.</p>
