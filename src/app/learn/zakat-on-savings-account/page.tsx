      ...
      <article className="min-h-screen bg-white px-6 py-16">
        <div className="mx-auto max-w-3xl">
          <nav className="mb-6 text-sm">
            ...
            <span className="mx-2 text-gray-400">/</span>
            <span className="text-gray-600">Zakat on Savings Accounts</span>
          </nav>

          <h1 className="text-4xl font-bold text-gray-900 mb-6">Zakat on Savings Accounts 2026</h1>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-3">Yes — Cash and Savings Are Zakatable</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-3">The Hawl Year: When Does the Clock Start?</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-3">Multiple Accounts: How to Combine</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-3">Interest (Riba) in Your Savings Account</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <div className="mt-12 bg-green-50 rounded-2xl p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">Link your accounts or enter balances manually. Barakah calculates your zakat, flags riba interest, and shows your hawl date tracker — all free.</p>
          ...
          <div className="mt-8 grid sm:grid-cols-3 gap-4">
            <Link href="/learn/nisab-threshold" className="block p-4 border rounded-lg hover:border-green-700 transition">
              ...
              <p className="text-sm text-gray-500 mt-1">Gold vs. silver nisab — current values and how to choose.</p>
            </Link>
            <Link href="/learn/what-is-zakat" className="block p-4 border rounded-lg hover:border-green-700 transition">
              ...
              <p className="text-sm text-gray-500 mt-1">The fundamentals of zakat — pillars, eligibility, and timing.</p>
            </Link>
            <Link href="/learn/riba-elimination" className="block p-4 border rounded-lg hover:border-green-700 transition">
              ...
              <p className="text-sm text-gray-500 mt-1">How to identify, purify, and avoid riba in your finances.</p>
            </Link>
          </div>
        </div>
      </article>
