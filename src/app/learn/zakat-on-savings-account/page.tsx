...
export const metadata: Metadata = {
  title: 'Zakat on Savings Accounts — Interest and Principal | Barakah',
  description: 'Understand zakat on savings account balances and how to handle interest (riba). The principal is zakatable while interest must be donated to charity.',
    ...
    <>
      ...
      <article className="min-h-screen bg-white px-6 py-16">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-6">Zakat on Savings Accounts</h1>
          <p className="text-lg text-gray-700 leading-relaxed mb-8">Understand zakat on savings account balances and how to handle interest (riba). The principal is zakatable while interest must be donated to charity.</p>
