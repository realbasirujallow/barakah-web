      ...
      <article className="min-h-screen bg-white px-6 py-16">
        <div className="mx-auto max-w-3xl">
          <nav className="mb-6 text-sm">
            ...
            <span className="mx-2 text-gray-400">/</span>
            <span className="text-gray-600">Zakat on Stocks and ETFs</span>
          </nav>

          <h1 className="text-4xl font-bold text-gray-900 mb-6">Zakat on Stocks and ETFs 2026</h1>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-3">Two Scholarly Approaches to Stock Zakat</h2>
            ...
            <div className="space-y-4 mb-4">
              <div className="border rounded-lg p-5">
                <h3 className="font-semibold text-gray-900 mb-2">Method 1 — Market Value (Simple)</h3>
                <p className="text-gray-700">Pay 2.5% of the total market value of your portfolio on your hawl date. Simple, conservative, and widely recommended for individual investors who cannot easily access company balance sheet data. Some scholars prefer this because it errs on the side of giving more zakat.</p>
              </div>
              <div className="border rounded-lg p-5">
                <h3 className="font-semibold text-gray-900 mb-2">Method 2 — Zakatable Assets per Share (AAOIFI Standard 21)</h3>
                <p className="text-gray-700">Research the underlying zakatable assets of each company (cash, receivables, inventory) per share, multiply by the number of shares you own, and pay 2.5% on that portion. More accurate but requires company financial data. This is the method endorsed by AAOIFI and most Islamic finance institutions globally.</p>
              </div>
            </div>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-3">Method 1: The Market Value Approach</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-3">Method 2: AAOIFI Zakatable Assets per Share</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <div className="bg-gray-50 border rounded-lg p-5 mb-4 text-gray-800">
              ...
              <p className="mt-2 text-sm text-gray-600">(Compare to Method 1: 200 shares &times; ~$230/share = $46,000 portfolio value &times; 2.5% = $1,150)</p>
            </div>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-3">ETF Zakat and Worked Examples</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <div className="bg-gray-50 border rounded-lg p-5 text-gray-800">
          ...
          <div className="mt-12 bg-green-50 rounded-2xl p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">Barakah&apos;s halal stock screener provides AAOIFI zakatable asset ratios for 30,000+ stocks so you can calculate Method 2 zakat accurately — free for all accounts.</p>
          ...
          <div className="mt-8 grid sm:grid-cols-3 gap-4">
            ...
            <Link href="/learn/halal-stocks" className="block p-4 border rounded-lg hover:border-green-700 transition">
              ...
              <p className="text-sm text-gray-500 mt-1">How to screen stocks for Shariah compliance.</p>
            </Link>
            <Link href="/learn/halal-investing-guide" className="block p-4 border rounded-lg hover:border-green-700 transition">
              ...
              <p className="text-sm text-gray-500 mt-1">Building a Shariah-compliant investment portfolio.</p>
            </Link>
          </div>
        </div>
      </article>
