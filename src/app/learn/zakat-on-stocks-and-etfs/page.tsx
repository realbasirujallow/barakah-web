...
export const metadata: Metadata = {
  title: 'Zakat on Stocks and ETFs — Complete Guide | Barakah',
  description: 'Calculate zakat on your stock portfolio, ETFs, mutual funds, and brokerage accounts. Use current market value on your hawl anniversary.',
    ...
    <>
      ...
      <article className="min-h-screen bg-white px-6 py-16">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-6">Zakat on Stocks and ETFs</h1>
          <p className="text-lg text-gray-700 leading-relaxed mb-8">Calculate zakat on your stock portfolio, ETFs, mutual funds, and brokerage accounts. Use current market value on your hawl anniversary.</p>
