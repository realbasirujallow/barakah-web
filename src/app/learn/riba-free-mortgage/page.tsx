...
export const metadata: Metadata = {
  title: 'Riba-Free Mortgage Alternatives for Muslims in America | Barakah',
  description: 'Explore halal home financing options including murabaha, ijara, and diminishing musharaka. Compare providers and find riba-free solutions.',
      ...
      <article className="min-h-screen bg-white px-6 py-16">
        <div className="mx-auto max-w-3xl">
          <nav className="mb-6 text-sm">
            ...
            <span className="mx-2 text-gray-400">/</span>
            <span className="text-gray-600">Riba-Free Mortgage Alternatives for Muslims in America</span>
          </nav>
          <h1 className="text-4xl font-bold text-gray-900 mb-6">Riba-Free Mortgage Alternatives for Muslims in America</h1>
          <p className="text-lg text-gray-700 leading-relaxed mb-8">Explore halal home financing options including murabaha, ijara, and diminishing musharaka. Compare providers and find riba-free solutions.</p>
