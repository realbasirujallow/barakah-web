    ...
    <>
      ...
      <article className="min-h-screen bg-white">
        ...
        <div className="max-w-3xl mx-auto px-6 py-10">
          ...
          <div className="bg-[#FFF8E1] border border-[#1B5E20] rounded-2xl p-6 mb-10">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div>
                ...
                <p className="text-gray-600 text-sm mt-1">Free multi-madhab calculator with live gold &amp; silver nisab prices.</p>
              </div>
          ...
          {/* Definition */}
          <h2 className="text-2xl font-bold text-gray-900 mt-10 mb-3">Definition: What Does Zakat Mean?</h2>
          ...
          {/* The Five Pillars */}
          <h2 className="text-2xl font-bold text-gray-900 mt-10 mb-3">Zakat as the Third Pillar of Islam</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
            Islam is built on five pillars (<em>arkan al-Islam</em>). Zakat is the third, standing alongside:
          </p>
          <ol className="list-decimal list-inside space-y-2 text-gray-700 mb-6 pl-2">
          ...
          {/* Five Conditions */}
          <h2 className="text-2xl font-bold text-gray-900 mt-10 mb-3">The Five Conditions for Zakat to Be Obligatory</h2>
          <p className="text-gray-700 leading-relaxed mb-4">Zakat is only obligatory when all five of the following conditions are met:</p>
          ...
          {/* Nisab */}
          <h2 className="text-2xl font-bold text-gray-900 mt-10 mb-3">Nisab: The Minimum Wealth Threshold</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <div className="grid sm:grid-cols-2 gap-4 mb-6">
            <div className="bg-[#FFF8E1] rounded-xl p-5 border border-green-100">
              ...
              <p className="text-2xl font-extrabold text-gray-900 mb-1">85 grams</p>
              <p className="text-sm text-gray-600">of pure gold at current market price. Recommended by AMJA and used by most Muslim scholars globally. Changes daily with gold prices.</p>
            </div>
            <div className="bg-gray-50 rounded-xl p-5 border border-gray-200">
              <p className="font-bold text-gray-700 text-lg mb-1">⚪ Silver Nisab</p>
              <p className="text-2xl font-extrabold text-gray-900 mb-1">612 grams</p>
              <p className="text-sm text-gray-600">of silver at current market price. Historically lower than gold nisab. Some scholars prefer this as more inclusive for those with modest wealth.</p>
            </div>
          </div>
          <p className="text-gray-700 leading-relaxed mb-4">
          ...
          {/* Calculation */}
          <h2 className="text-2xl font-bold text-gray-900 mt-10 mb-3">How to Calculate Zakat: The Formula</h2>
          ...
          {/* Asset categories */}
          <h2 className="text-2xl font-bold text-gray-900 mt-10 mb-4">What Assets are Zakatable? (Complete List)</h2>
          <div className="space-y-3 mb-8">
            {[
              ...
              <Link key={asset.title} href={asset.link} className="flex gap-4 p-4 border border-gray-100 rounded-xl hover:border-[#1B5E20] transition group">
                <span className="text-2xl shrink-0">{asset.emoji}</span>
                <div>
                  <p className="font-semibold text-gray-900 group-hover:text-[#1B5E20]">{asset.title} →</p>
                  <p className="text-sm text-gray-600 mt-0.5">{asset.desc}</p>
                </div>
              </Link>
            ))}
          </div>
          ...
          {/* Non-zakatable */}
          <h2 className="text-2xl font-bold text-gray-900 mt-10 mb-3">What is NOT Zakatable</h2>
          ...
          {/* Hawl */}
          <h2 className="text-2xl font-bold text-gray-900 mt-10 mb-3">Hawl: The One-Year Condition Explained</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <div className="bg-[#1B5E20] text-white rounded-2xl p-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Link href="/zakat-calculator" className="bg-white text-[#1B5E20] px-6 py-3 rounded-xl font-bold hover:bg-green-50 transition">
                Calculate My Zakat Free
              </Link>
          ...
          <div className="mt-10 pt-8 border-t border-gray-100">
            <h3 className="font-semibold text-gray-900 mb-4">Learn More About Zakat</h3>
