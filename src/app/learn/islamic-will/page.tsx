        ...
        <main className="flex-1 max-w-4xl mx-auto w-full px-6 py-10">
          <article className="space-y-8">
            <header className="space-y-4">
              ...
              <p className="text-lg text-gray-700 dark:text-gray-300">Every Muslim needs a will. Learn the Shariah rules of inheritance, the 1/3 bequest limit, faraid shares for legal heirs, and how to create a legally valid Islamic will in the West.</p>
            ...
            <section id="why-will" className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="bg-red-50 border-l-4 border-red-500 p-4 rounded">
                  <p className="text-gray-700 dark:text-gray-300"><strong className="text-red-600">Without a will:</strong> Your estate may be divided by secular courts in ways that contradict Islamic inheritance rules, potentially depriving rightful heirs of their shares.</p>
                </div>
                <div className="bg-red-50 border-l-4 border-red-500 p-4 rounded">
                  <p className="text-gray-700 dark:text-gray-300"><strong className="text-red-600">Without a will:</strong> Your children may be placed under the guardianship of non-Muslim relatives or state authorities if both parents pass away.</p>
                </div>
                <div className="bg-red-50 border-l-4 border-red-500 p-4 rounded">
                  <p className="text-gray-700 dark:text-gray-300"><strong className="text-red-600">Without a will:</strong> You cannot designate bequests to charity, mosques, or Islamic organizations from the permissible one-third.</p>
                </div>
              </div>
            </section>
              ...
              <div className="overflow-x-auto my-6">
                <table className="w-full border border-gray-300 dark:border-gray-600">
                  <thead className="bg-[#1B5E20] text-white">
                    <tr>
                      <th className="border border-gray-300 p-3 text-left dark:border-gray-600">Heir</th>
                      <th className="border border-gray-300 p-3 text-left dark:border-gray-600">Share (with children)</th>
                      <th className="border border-gray-300 p-3 text-left dark:border-gray-600">Share (without children)</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr className="bg-white dark:bg-gray-800">
                      <td className="border border-gray-300 p-3 font-semibold dark:border-gray-600">Husband</td>
                      <td className="border border-gray-300 p-3 dark:border-gray-600">1/4 of wife&apos;s estate</td>
                      <td className="border border-gray-300 p-3 dark:border-gray-600">1/2 of wife&apos;s estate</td>
                    </tr>
                    <tr className="bg-gray-50 dark:bg-gray-800">
                      <td className="border border-gray-300 p-3 font-semibold dark:border-gray-600">Wife</td>
                      <td className="border border-gray-300 p-3 dark:border-gray-600">1/8 of husband&apos;s estate</td>
                      <td className="border border-gray-300 p-3 dark:border-gray-600">1/4 of husband&apos;s estate</td>
                    </tr>
                    <tr className="bg-white dark:bg-gray-800">
                      <td className="border border-gray-300 p-3 font-semibold dark:border-gray-600">Father</td>
                      <td className="border border-gray-300 p-3 dark:border-gray-600">1/6</td>
                      <td className="border border-gray-300 p-3 dark:border-gray-600">Residuary (asaba)</td>
                    </tr>
                    <tr className="bg-gray-50 dark:bg-gray-800">
                      <td className="border border-gray-300 p-3 font-semibold dark:border-gray-600">Mother</td>
                      <td className="border border-gray-300 p-3 dark:border-gray-600">1/6</td>
                      <td className="border border-gray-300 p-3 dark:border-gray-600">1/3</td>
                    </tr>
                    <tr className="bg-white dark:bg-gray-800">
                      <td className="border border-gray-300 p-3 font-semibold dark:border-gray-600">Son(s)</td>
                      <td className="border border-gray-300 p-3 dark:border-gray-600" colSpan={2}>Residuary (receives remainder after fixed shares)</td>
                    </tr>
                    <tr className="bg-gray-50 dark:bg-gray-800">
                      <td className="border border-gray-300 p-3 font-semibold dark:border-gray-600">Daughter(s) only</td>
                      <td className="border border-gray-300 p-3 dark:border-gray-600" colSpan={2}>2/3 if two or more; 1/2 if one (no sons)</td>
                    </tr>
                    <tr className="bg-white dark:bg-gray-800">
                      <td className="border border-gray-300 p-3 font-semibold dark:border-gray-600">Son(s) and Daughter(s)</td>
                      <td className="border border-gray-300 p-3 dark:border-gray-600" colSpan={2}>Males receive twice the female share from the residuary</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <section className="mt-12 border-t border-gray-200 pt-8 dark:border-gray-700">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                >
                  ...
                  <p className="text-gray-600 text-sm dark:text-gray-400">Calculate zakat on your cash and savings before estate planning.</p>
                </Link>
                <Link
                ...
                >
                  ...
                  <p className="text-gray-600 text-sm dark:text-gray-400">Core principles of Islamic finance including riba, gharar, and halal investing.</p>
                </Link>
              </div>
            </section>
