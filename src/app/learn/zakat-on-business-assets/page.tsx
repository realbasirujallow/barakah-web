...
export const metadata: Metadata = {
  title: 'Zakat on Business Assets and Inventory | Barakah',
  description: 'Learn which business assets are subject to zakat. Inventory for sale is zakatable while equipment and machinery used in the business are exempt.',
      ...
      <article className="min-h-screen bg-white px-6 py-16">
        <div className="mx-auto max-w-3xl">
          <nav className="mb-6 text-sm">
            ...
            <span className="mx-2 text-gray-400">/</span>
            <span className="text-gray-600">Zakat on Business Assets and Inventory</span>
          </nav>
          <h1 className="text-4xl font-bold text-gray-900 mb-6">Zakat on Business Assets and Inventory</h1>
          <p className="text-lg text-gray-700 leading-relaxed mb-8">Learn which business assets are subject to zakat. Inventory for sale is zakatable while equipment and machinery used in the business are exempt.</p>
