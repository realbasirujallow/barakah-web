      ...
      <article className="min-h-screen bg-white px-6 py-16 dark:bg-gray-800">
        <div className="mx-auto max-w-3xl">
          <nav className="mb-6 text-sm">
            ...
            <span className="mx-2 text-gray-400">/</span>
            <span className="text-gray-600 dark:text-gray-400">Zakat on Business Assets</span>
          </nav>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-3 dark:text-gray-100">What Business Assets Are Zakatable?</h2>
            ...
            <p className="text-gray-700 leading-relaxed mb-3 dark:text-gray-300">NOT zakatable:</p>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-3 dark:text-gray-100">Inventory Valuation: Cost vs. Market Price</h2>
            <p className="text-gray-700 leading-relaxed mb-4 dark:text-gray-300">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-3 dark:text-gray-100">Special Cases: Online Sellers, Freelancers, Partnerships</h2>
            <p className="text-gray-700 leading-relaxed mb-4 dark:text-gray-300">
          ...
          <div className="mt-8 grid sm:grid-cols-3 gap-4">
            <Link href="/learn/what-is-zakat" className="block p-4 border rounded-lg hover:border-green-700 transition">
              ...
              <p className="text-sm text-gray-500 mt-1 dark:text-gray-400">The fundamentals of zakat — who owes it and when.</p>
            </Link>
            <Link href="/learn/zakat-on-savings-account" className="block p-4 border rounded-lg hover:border-green-700 transition">
              ...
              <p className="text-sm text-gray-500 mt-1 dark:text-gray-400">How to calculate zakat on cash and bank balances.</p>
            </Link>
