...
export const metadata: Metadata = {
  title: 'Islamic Will (Wasiyyah) Template — Free Download | Barakah',
  description: 'Create your Islamic will with our free wasiyyah guide. Understand the Quranic inheritance shares and ensure your estate is distributed correctly.',
      ...
      <article className="min-h-screen bg-white px-6 py-16">
        <div className="mx-auto max-w-3xl">
          <nav className="mb-6 text-sm">
            ...
            <span className="mx-2 text-gray-400">/</span>
            <span className="text-gray-600">Islamic Will (Wasiyyah) Template</span>
          </nav>
          <h1 className="text-4xl font-bold text-gray-900 mb-6">Islamic Will (Wasiyyah) Template</h1>
          <p className="text-lg text-gray-700 leading-relaxed mb-8">Create your Islamic will with our free wasiyyah guide. Understand the Quranic inheritance shares and ensure your estate is distributed correctly.</p>
