              ...
              <div className="overflow-x-auto">
                <table className="w-full text-sm rounded-lg bg-white shadow-sm dark:bg-gray-800">
                  ...
                  <tbody className="text-gray-800 dark:text-gray-300">
                    ...
                    <tr className="border-b border-gray-100 dark:border-gray-700"><td className="p-3 font-semibold">Islamic-bank mudaraba savings</td><td className="p-3">Profit-sharing deposit</td><td className="p-3">US (UIF)</td><td className="p-3">N/A</td><td className="p-3">FDIC-insured cash sleeve</td></tr>
