...
export const metadata: Metadata = {
  title: 'Halal Budgeting — Islamic Approach to Managing Money | Barakah',
  description: 'Learn how to create a halal budget that aligns with Islamic principles. Avoid riba, prioritize zakat, and build a financially disciplined household.',
    ...
    <>
      ...
      <article className="min-h-screen bg-white px-6 py-16">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-6">Halal Budgeting</h1>
          <p className="text-lg text-gray-700 leading-relaxed mb-8">Learn how to create a halal budget that aligns with Islamic principles. Avoid riba, prioritize zakat, and build a financially disciplined household.</p>
