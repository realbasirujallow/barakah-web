...
export const metadata: Metadata = {
  title: 'Ramadan Charitable Giving Tracker — Maximize Your Reward | Barakah',
  description: 'Track your Ramadan sadaqah, zakat, and iftar donations in one place. Stay organized and ensure nothing is missed during the blessed month.',
      ...
      <article className="min-h-screen bg-white px-6 py-16">
        <div className="mx-auto max-w-3xl">
          <nav className="mb-6 text-sm">
            ...
            <span className="mx-2 text-gray-400">/</span>
            <span className="text-gray-600">Ramadan Charitable Giving Tracker</span>
          </nav>
          <h1 className="text-4xl font-bold text-gray-900 mb-6">Ramadan Charitable Giving Tracker</h1>
          <p className="text-lg text-gray-700 leading-relaxed mb-8">Track your Ramadan sadaqah, zakat, and iftar donations in one place. Stay organized and ensure nothing is missed during the blessed month.</p>
