    ...
    <>
      ...
      <article className="min-h-screen bg-white px-6 py-16">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-6">Zakat on Gold Jewelry — Hanafi, Shafi&apos;i &amp; All Madhab Rulings</h1>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-3">The Core Question: Is Gold Jewelry Zakatable?</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-3">Hanafi Ruling: All Gold Is Zakatable</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-3">Shafi&apos;i, Maliki &amp; Hanbali: Personal-Use Jewelry May Be Exempt</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-3">How to Calculate Gold Zakat</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <div className="mt-12 bg-green-50 rounded-2xl p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">Enter your gold weight and karat. Barakah fetches the live spot price and applies your madhab&apos;s ruling automatically — Hanafi, Shafi&apos;i, Maliki, or Hanbali.</p>
          ...
          <div className="mt-8 grid sm:grid-cols-3 gap-4">
            <Link href="/learn/zakat-on-savings-account" className="block p-4 border rounded-lg hover:border-green-700 transition">
              ...
              <p className="text-sm text-gray-500 mt-1">How to calculate zakat on bank savings and cash.</p>
            </Link>
            <Link href="/learn/nisab-threshold" className="block p-4 border rounded-lg hover:border-green-700 transition">
              ...
              <p className="text-sm text-gray-500 mt-1">Gold vs. silver nisab — which to use and why it matters.</p>
            </Link>
