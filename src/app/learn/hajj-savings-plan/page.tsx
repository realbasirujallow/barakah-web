...
export const metadata: Metadata = {
  title: 'Hajj Savings Plan — How to Save for Your Pilgrimage | Barakah',
  description: 'Create a structured savings plan for Hajj. Calculate costs, set monthly targets, and track progress toward the journey of a lifetime.',
    ...
    <>
      ...
      <article className="min-h-screen bg-white px-6 py-16">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-6">Hajj Savings Plan</h1>
          <p className="text-lg text-gray-700 leading-relaxed mb-8">Create a structured savings plan for Hajj. Calculate costs, set monthly targets, and track progress toward the journey of a lifetime.</p>
