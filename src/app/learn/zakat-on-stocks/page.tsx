            ...
            <section id="which-method" className="space-y-4">
              ...
              <div className="space-y-4 my-6">
                <div className="border-l-4 border-[#1B5E20] bg-green-50 p-4 rounded">
                  ...
                  <ul className="text-gray-700 text-sm space-y-1 list-disc list-inside dark:text-gray-300">
            ...
            <section id="mistakes" className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="bg-red-50 border-l-4 border-red-500 p-4 rounded">
                  <p className="text-gray-700 dark:text-gray-300"><strong className="text-red-600">Using purchase price instead of market value:</strong> Zakat is calculated on the current market value of your investments, not what you originally paid. A stock you bought at $50 that is now worth $100 owes zakat on $100.</p>
                </div>
                <div className="bg-red-50 border-l-4 border-red-500 p-4 rounded">
                  <p className="text-gray-700 dark:text-gray-300"><strong className="text-red-600">Forgetting to combine all assets:</strong> Your stocks, cash, gold, and other zakatable assets should be combined when checking against the nisab threshold and calculating total zakat.</p>
                </div>
                <div className="bg-red-50 border-l-4 border-red-500 p-4 rounded">
                  <p className="text-gray-700 dark:text-gray-300"><strong className="text-red-600">Not accounting for dividends:</strong> Dividends you receive and hold as cash are zakatable as part of your cash savings. Do not double-count them (once as stock value and once as cash).</p>
                </div>
                <div className="bg-red-50 border-l-4 border-red-500 p-4 rounded">
                  <p className="text-gray-700 dark:text-gray-300"><strong className="text-red-600">Ignoring retirement accounts:</strong> 401(k), IRA, and other retirement accounts holding stocks are also zakatable. See our <Link href="/learn/zakat-on-401k" className="text-red-600 underline">zakat on 401(k) guide</Link> for details.</p>
                </div>
                <div className="bg-red-50 border-l-4 border-red-500 p-4 rounded">
                  <p className="text-gray-700 dark:text-gray-300"><strong className="text-red-600">Using an inconsistent zakat date:</strong> Pick one date per year and stick to it. Switching dates to avoid paying zakat when markets are high is not permissible.</p>
                </div>
              </div>
            </section>
            ...
            <section className="mt-12 border-t border-gray-200 pt-8 dark:border-gray-700">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                >
                  ...
                  <p className="text-gray-600 text-sm dark:text-gray-400">How to screen stocks for Shariah compliance using AAOIFI standards.</p>
                </Link>
                <Link
                ...
                >
                  ...
                  <p className="text-gray-600 text-sm dark:text-gray-400">Three scholarly positions on retirement account zakat with tax deduction examples.</p>
                </Link>
              </div>
            </section>
