...
export const metadata: Metadata = {
  title: 'Zakat Al-Fitr Calculator 2026 — How Much to Pay | Barakah',
  description: 'Calculate your Zakat Al-Fitr (Fitrana) obligation for Ramadan 2026. Understand the ruling, amount, and timing for your family.',
    ...
    <>
      ...
      <article className="min-h-screen bg-white px-6 py-16">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-6">Zakat Al-Fitr Calculator 2026</h1>
          <p className="text-lg text-gray-700 leading-relaxed mb-8">Calculate your Zakat Al-Fitr (Fitrana) obligation for Ramadan 2026. Understand the ruling, amount, and timing for your family.</p>
