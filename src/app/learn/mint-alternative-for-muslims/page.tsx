        ...
        <div className="max-w-3xl mx-auto px-6 py-10">
          ...
          <div className="grid sm:grid-cols-2 gap-4 mb-8">
            {[
              ...
              { icon: '✅', title: 'Halal Stock Screener', desc: 'AAOIFI Standard 21 ratio screening on demand for any ticker, against a 30,000+ stock business-activity library. Methodology-aware signals — review with a scholar for personal rulings.' },
          ...
          <ol className="space-y-4 mb-8">
            {[
              { step: '1', title: 'Create your free Barakah account', desc: `Go to trybarakah.com and sign up. No credit card or debit card required. You get ${DEFAULT_ONBOARDING_TRIAL_DAYS_LABEL} of Family free automatically.` },
          ...
          <div className="bg-[#FFF8E1] border border-[#1B5E20] rounded-2xl p-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Link href="/signup" className="bg-[#1B5E20] text-white px-8 py-3.5 rounded-xl font-bold hover:bg-[#2E7D32] transition">
                Start Free — 7 Days Family Included
              </Link>
