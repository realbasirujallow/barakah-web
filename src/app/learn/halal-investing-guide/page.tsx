    ...
    <>
      ...
      <article className="min-h-screen bg-white">
        ...
        <div className="max-w-3xl mx-auto px-6 py-10">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-10 mb-4">Core Principles of Islamic Investing</h2>
          ...
          {/* Haram Sectors */}
          <h2 className="text-2xl font-bold text-gray-900 mt-10 mb-4">Haram Industries to Avoid</h2>
          ...
          {/* AAOIFI Screening */}
          <h2 className="text-2xl font-bold text-gray-900 mt-10 mb-4">AAOIFI Standard 21: The Halal Stock Screening Criteria</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <h3 className="text-lg font-bold text-gray-900 mt-6 mb-3">1. Business Activity Screen</h3>
          <p className="text-gray-700 mb-4">A company must derive <strong>less than 5% of total revenue</strong> from prohibited activities. Even if a company sells mostly halal products, if 5%+ of revenue comes from alcohol, interest, etc., it fails.</p>

          <h3 className="text-lg font-bold text-gray-900 mt-6 mb-3">2. Financial Ratio Screens</h3>
          <div className="space-y-3 mb-6">
            {[
              ...
              <div key={r.ratio} className="flex gap-4 p-4 bg-gray-50 rounded-xl border border-gray-200">
                <div className="shrink-0">
                  <p className="font-mono text-sm font-bold text-gray-800">{r.ratio}</p>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-10 mb-4">Types of Halal Investments in 2026</h2>
          ...
          {/* Purification */}
          <h2 className="text-2xl font-bold text-gray-900 mt-10 mb-3">Purification of Haram Income</h2>
          <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <div className="bg-[#1B5E20] text-white rounded-2xl p-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Link href="/signup" className="bg-white text-[#1B5E20] px-6 py-3 rounded-xl font-bold hover:bg-green-50 transition">
