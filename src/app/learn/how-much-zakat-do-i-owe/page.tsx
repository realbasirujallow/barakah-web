...
export const metadata: Metadata = {
  title: 'How Much Zakat Do I Owe? — Quick Calculator | Barakah',
  description: 'Calculate your total zakat obligation in under 60 seconds. Enter your assets, debts, and gold holdings to get an instant calculation.',
    ...
    <>
      ...
      <article className="min-h-screen bg-white px-6 py-16">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-6">How Much Zakat Do I Owe?</h1>
          <p className="text-lg text-gray-700 leading-relaxed mb-8">Calculate your total zakat obligation in under 60 seconds. Enter your assets, debts, and gold holdings to get an instant calculation.</p>
