        ...
        <main className="flex-1 max-w-4xl mx-auto w-full px-6 py-10">
          <article className="space-y-8">
            ...
            <footer className="mt-12 pt-8 border-t border-gray-200 text-sm text-gray-600 dark:text-gray-400 dark:border-gray-700">
              ...
              <p className="mt-2">Methodology draws on classical Islamic jurisprudence and hadith sources including Sahih Bukhari (1503) and other classical collections; published scholarly positions are referenced where noted.</p>
            </footer>
          </article>
