        ...
        <main className="flex-1 max-w-4xl mx-auto w-full px-6 py-10">
          <article className="space-y-8">
            <header className="space-y-4">
              ...
              <p className="text-lg text-gray-700">Complete guide to zakat al-fitr (fitrah) for Eid al-Fitr with 2026 amounts and Islamic fiqh references.</p>
              ...
              <div className="overflow-x-auto my-6">
                <table className="w-full border border-gray-300">
                  <thead className="bg-[#1B5E20] text-white">
                    <tr>
                      <th className="border border-gray-300 p-3 text-left">Food Type</th>
                      <th className="border border-gray-300 p-3 text-left">Per Person Amount</th>
                      <th className="border border-gray-300 p-3 text-left">Family of 5</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr className="bg-white">
                      <td className="border border-gray-300 p-3">Dates</td>
                      <td className="border border-gray-300 p-3">$12-15</td>
                      <td className="border border-gray-300 p-3">$60-75</td>
                    </tr>
                    <tr className="bg-gray-50">
                      <td className="border border-gray-300 p-3">Wheat/Flour</td>
                      <td className="border border-gray-300 p-3">$7-10</td>
                      <td className="border border-gray-300 p-3">$35-50</td>
                    </tr>
                    <tr className="bg-white">
                      <td className="border border-gray-300 p-3">Rice</td>
                      <td className="border border-gray-300 p-3">$8-12</td>
                      <td className="border border-gray-300 p-3">$40-60</td>
                    </tr>
                    <tr className="bg-gray-50">
                      <td className="border border-gray-300 p-3">Barley</td>
                ...
                <table className="w-full border border-gray-300">
                  <thead className="bg-[#1B5E20] text-white">
                    <tr>
                      ...
                      <th className="border border-gray-300 p-3 text-left">Zakat al-Fitr</th>
                      <th className="border border-gray-300 p-3 text-left">Zakat al-Mal</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr className="bg-white">
                      <td className="border border-gray-300 p-3 font-semibold">When Due</td>
                      <td className="border border-gray-300 p-3">End of Ramadan (before Eid prayer)</td>
                      <td className="border border-gray-300 p-3">After holding wealth for 1 lunar year</td>
                    </tr>
                    <tr className="bg-gray-50">
                      <td className="border border-gray-300 p-3 font-semibold">Who Pays</td>
                      <td className="border border-gray-300 p-3">Every Muslim (no nisab required)</td>
                      <td className="border border-gray-300 p-3">Those with wealth above nisab</td>
                    </tr>
                    <tr className="bg-white">
                    ...
                    <tr className="bg-gray-50">
                      ...
                      <td className="border border-gray-300 p-3">Purify the fast, aid poor for Eid</td>
                      <td className="border border-gray-300 p-3">Annual wealth purification</td>
                    </tr>
                    <tr className="bg-white">
                      <td className="border border-gray-300 p-3 font-semibold">Frequency</td>
                      <td className="border border-gray-300 p-3">Once per year (at Eid only)</td>
                      <td className="border border-gray-300 p-3">Once per year (on anniversary)</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <section className="mt-12 border-t border-gray-200 pt-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                >
                  ...
                  <p className="text-gray-600 text-sm">Understand zakat as a pillar of Islamic finance and charitable giving.</p>
                </Link>
                <Link
                ...
                >
                  ...
                  <p className="text-gray-600 text-sm">Calculate zakat on your liquid assets and savings accounts.</p>
                </Link>
              </div>
            </section>
