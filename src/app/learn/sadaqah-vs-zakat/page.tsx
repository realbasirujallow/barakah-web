...
export const metadata: Metadata = {
  title: 'Sadaqah vs Zakat — What Is the Difference? | Barakah',
  description: 'Understand the key differences between zakat (obligatory) and sadaqah (voluntary charity). Learn when each applies and how to maximize your reward.',
    ...
    <>
      ...
      <article className="min-h-screen bg-white px-6 py-16">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-6">Sadaqah vs Zakat</h1>
          <p className="text-lg text-gray-700 leading-relaxed mb-8">Understand the key differences between zakat (obligatory) and sadaqah (voluntary charity). Learn when each applies and how to maximize your reward.</p>
