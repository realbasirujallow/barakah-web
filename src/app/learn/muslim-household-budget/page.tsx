...
export const metadata: Metadata = {
  title: 'Muslim Household Budget Template — Free Tool | Barakah',
  description: 'Build a household budget that accounts for zakat, sadaqah, Hajj savings, and Islamic obligations alongside everyday expenses.',
    ...
    <>
      ...
      <article className="min-h-screen bg-white px-6 py-16">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-6">Muslim Household Budget Template</h1>
          <p className="text-lg text-gray-700 leading-relaxed mb-8">Build a household budget that accounts for zakat, sadaqah, Hajj savings, and Islamic obligations alongside everyday expenses.</p>
