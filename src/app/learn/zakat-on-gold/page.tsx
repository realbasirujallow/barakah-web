  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'The nisab for gold is 85 grams (approximately 2.747 troy ounces), consistent with the gold-nisab figure published by AMJA and used across most contemporary fiqh councils. Some scholars use a lower threshold based on silver (approximately 595 grams; classical fiqh texts specify ~612g). Pick the threshold your madhab or local scholar follows.',
      },
    },
    {
      '@type': 'Question',
