        ...
        <main className="flex-1 max-w-4xl mx-auto w-full px-6 py-10">
          <article className="space-y-8">
            <header className="space-y-4">
              ...
              <p className="text-lg text-gray-700">A complete guide to identifying Shariah-compliant stocks using AAOIFI standards, understanding halal vs. haram sectors, and building a portfolio that aligns with your faith.</p>
            ...
            <section id="sectors" className="space-y-4">
              ...
              <div className="overflow-x-auto my-6">
                <table className="w-full border border-gray-300">
                  <thead className="bg-[#1B5E20] text-white">
                    <tr>
                      <th className="border border-gray-300 p-3 text-left">Generally Halal Sectors</th>
                      <th className="border border-gray-300 p-3 text-left">Generally Haram Sectors</th>
                      <th className="border border-gray-300 p-3 text-left">Requires Individual Screening</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr className="bg-white">
                      <td className="border border-gray-300 p-3 text-sm">Technology & Software</td>
                      <td className="border border-gray-300 p-3 text-sm">Conventional Banks & Insurance</td>
                      <td className="border border-gray-300 p-3 text-sm">Pharmaceuticals</td>
                    </tr>
                    <tr className="bg-gray-50">
                      <td className="border border-gray-300 p-3 text-sm">Healthcare & Medical Devices</td>
                      <td className="border border-gray-300 p-3 text-sm">Alcohol & Breweries</td>
                      <td className="border border-gray-300 p-3 text-sm">Entertainment & Media</td>
                    </tr>
                    <tr className="bg-white">
                      <td className="border border-gray-300 p-3 text-sm">Halal Food & Agriculture</td>
                      <td className="border border-gray-300 p-3 text-sm">Casinos & Gambling</td>
                      <td className="border border-gray-300 p-3 text-sm">Restaurants & Hospitality</td>
                    </tr>
                    <tr className="bg-gray-50">
                      <td className="border border-gray-300 p-3 text-sm">Renewable Energy & Utilities</td>
                      <td className="border border-gray-300 p-3 text-sm">Pork & Non-Halal Meat</td>
                      <td className="border border-gray-300 p-3 text-sm">Real Estate (REITs)</td>
                    </tr>
                    <tr className="bg-white">
                      <td className="border border-gray-300 p-3 text-sm">E-commerce & Logistics</td>
                      <td className="border border-gray-300 p-3 text-sm">Adult Entertainment</td>
                      <td className="border border-gray-300 p-3 text-sm">Conglomerates</td>
                    </tr>
                    <tr className="bg-gray-50">
                      <td className="border border-gray-300 p-3 text-sm">Manufacturing & Industrial</td>
                      <td className="border border-gray-300 p-3 text-sm">Tobacco</td>
                      <td className="border border-gray-300 p-3 text-sm">Consumer Staples</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              ...
              <div className="bg-red-50 border-l-4 border-red-500 p-4 rounded">
                <p className="text-gray-700"><strong className="text-red-600">Important:</strong> Even stocks in &quot;generally halal&quot; sectors must be individually screened for financial ratios. A tech company with 40% debt-to-market-cap ratio would fail the AAOIFI screen despite its halal business activities.</p>
              </div>
            </section>
            ...
            <section id="ratios" className="space-y-4">
              ...
              <div className="overflow-x-auto my-6">
                <table className="w-full border border-gray-300">
                  <thead className="bg-[#1B5E20] text-white">
                    <tr>
                      <th className="border border-gray-300 p-3 text-left">Ratio</th>
                      <th className="border border-gray-300 p-3 text-left">AAOIFI Threshold</th>
                      <th className="border border-gray-300 p-3 text-left">What It Measures</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr className="bg-white">
                      <td className="border border-gray-300 p-3 font-semibold">Debt Ratio</td>
                      <td className="border border-gray-300 p-3">&lt; 33% of market cap</td>
                      <td className="border border-gray-300 p-3 text-sm">Reliance on interest-bearing loans</td>
                    </tr>
                    <tr className="bg-gray-50">
                      <td className="border border-gray-300 p-3 font-semibold">Interest Securities</td>
                      <td className="border border-gray-300 p-3">&lt; 33% of market cap</td>
                      <td className="border border-gray-300 p-3 text-sm">Holdings in bonds or interest deposits</td>
                    </tr>
                    <tr className="bg-white">
                      <td className="border border-gray-300 p-3 font-semibold">Impermissible Income</td>
                      <td className="border border-gray-300 p-3">&lt; 5% of revenue</td>
                      <td className="border border-gray-300 p-3 text-sm">Revenue from haram sources</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <section className="mt-12 border-t border-gray-200 pt-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                >
                  ...
                  <p className="text-gray-600 text-sm">How to calculate zakat on your stock portfolio, mutual funds, and crypto.</p>
                </Link>
                <Link
                ...
                >
                  ...
                  <p className="text-gray-600 text-sm">Foundational principles of halal finance, riba, and ethical investing.</p>
                </Link>
              </div>
            </section>
