      ...
      <article className="min-h-screen bg-white px-6 py-16">
        <div className="mx-auto max-w-3xl">
          <nav className="mb-6 text-sm">
            ...
            <span className="mx-2 text-gray-400">/</span>
            <span className="text-gray-600">Zakat on Cryptocurrency</span>
          </nav>
          <h1 className="text-4xl font-bold text-gray-900 mb-6">Zakat on Cryptocurrency</h1>
          <p className="text-lg text-gray-700 leading-relaxed mb-8">Cryptocurrency is a relatively new asset class, and Islamic scholars have reached a strong consensus: crypto holdings that have been held for one full lunar year (hawl) above the nisab threshold are subject to zakat at the standard 2.5% rate.</p>
          
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-3">Is Crypto Zakatable?</h2>
            <p className="text-gray-700 leading-relaxed">Yes. The majority of contemporary scholars — including AMJA, Dr. Monzer Kahf, and the Fiqh Council of North America — treat cryptocurrency as zakatable wealth similar to cash or stocks. If your crypto portfolio&apos;s market value exceeds the nisab threshold on your hawl anniversary, zakat is due.</p>
          </section>
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-3">How to Calculate</h2>
            <p className="text-gray-700 leading-relaxed">Take the total market value of all your crypto holdings on your hawl date. If it exceeds nisab (approximately $14,025 based on 85g of gold), multiply the total by 2.5%. For example, if you hold $20,000 in Bitcoin and Ethereum combined, your zakat would be $500.</p>
          </section>
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-3">Staking and DeFi Yields</h2>
            <p className="text-gray-700 leading-relaxed">Income from staking, yield farming, or DeFi protocols is treated similarly to investment returns. The principal plus accumulated yields are included in your zakatable wealth on your hawl date.</p>
          </section>
          ...
          <section className="mb-8">
            ...
            <div className="space-y-4">
              <details className="border rounded-lg">
                <summary className="p-4 cursor-pointer font-semibold text-gray-900 hover:text-green-700">Do I pay zakat on crypto I&apos;ve held for less than a year?</summary>
                <div className="px-4 pb-4 text-gray-700">No. Zakat requires a full lunar year (hawl) of ownership above nisab. If you bought crypto less than 354 days ago, it is not yet zakatable — but it will be once the hawl completes.</div>
              </details>
              <details className="border rounded-lg">
                <summary className="p-4 cursor-pointer font-semibold text-gray-900 hover:text-green-700">What about NFTs?</summary>
                <div className="px-4 pb-4 text-gray-700">NFTs held for investment are treated like any other digital asset. If you intend to sell them, their market value is zakatable. NFTs held for personal use (display art) are generally exempt, similar to personal property.</div>
              </details>
              <details className="border rounded-lg">
                <summary className="p-4 cursor-pointer font-semibold text-gray-900 hover:text-green-700">Do I use the purchase price or current market value?</summary>
                <div className="px-4 pb-4 text-gray-700">Use the current market value on your hawl anniversary date, not the purchase price. Zakat is based on what you own today, not what you paid.</div>
              </details>
            </div>
          </section>
