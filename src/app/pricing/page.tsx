...
const faqItems = [
  ...
  },
  {
    ...
    // close the last objection for cautious buyers. The seven-day trial
    ...
    answer:
      "Yes. If Barakah Plus or Family isn't a fit in your first 30 days as a paying customer, email support@trybarakah.com and we'll refund your first month, no questions. This is on top of the 7-day no-card trial that runs before any charge.",
  },
  {
